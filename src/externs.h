...
extern bool unified_use;    /* single command to use any consumable / device / activatable item */
...
extern bool no_id;        /* All items / flavors IDed at start */
...
extern void display_news_win(n);
...
extern class_t *logrus_master_get_class(void);
