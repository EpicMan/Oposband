...
device_effect_info_t staff_effect_table[] =
{
    ...
    /*{EFFECT_IDENTIFY,              10,   4,     1,   0,    10,  0, _STOCK_TOWN | _COMMON},*/ /* Available too freely and early, scrolls of ID almost worthless */
    ...
    {EFFECT_IDENTIFY,              40,  20,     3,   0,    10,  0, _COMMON}, /* Was EFFECT_IDENTIFY_FULL */
