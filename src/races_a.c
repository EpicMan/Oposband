...
race_t* ghoul_get_race(void)
{
    ...
    if (!init)
    {
        ...
        me.stats[A_STR] = 1; /* was 0 */
        me.stats[A_INT] = -1;
        me.stats[A_WIS] = -1;
        me.stats[A_DEX] = 0; /* was -1 */
        me.stats[A_CON] = 1;
        me.stats[A_CHR] = -5;
...
race_t *hobbit_get_race(void)
{
    ...
    if (!init)
    {
        ...
        me.desc = "Hobbits (or Halflings) have exceptional stealth and are very good at bows "
                    ...
                    "to find food in the dark depths of the dungeon. Hobbits absolutely refuse to "
                    "wear shoes of any sort on their furry feet.";
...
static power_info _icky_thing_get_powers[] =
{
    ...
    /* TODO: Need a power to charm immobile mobs */
    { -1, {-1, -1, -1, NULL} }
};
